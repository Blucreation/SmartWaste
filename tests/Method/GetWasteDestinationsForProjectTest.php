...
class GetWasteDestinationsForProjectTest extends TestCase
{
    /**
    ...
    {
        new GetWasteDestinationsForProject();
    }

    public function testInit()
    {
        $uri = new GetWasteDestinationsForProject(ConvertEntity::ID, ConvertEntity::ID);
